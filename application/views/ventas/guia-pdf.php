...
<html lang="es">
    ...
    <body>
        ...
        <header>
			...
			<table cellspacing="0" cellpadding="1" align="center" style="text-align:center;margin-top:3mm" width="18cm">
				<tr><td><b>REPORTE DE SALIDA DE PRODUCTOS A CLIENTE</b></td></tr>
				<tr><td>
        ...
        <main style="overflow-y: hidden">
			<table cellspacing="0" cellpadding="1" align="center" class="acciones">
				...
				<tr style="font-weight:bold;" bgcolor="#B5B2B2">
					...
					<td colspan="2">Cantidad Total (Kg)</td><td colspan="2">Precio(S/)</td>
				</tr>
	<?
			$i = 1;
			foreach($guia as $row):
	?>
				<tr>
					...
					<td style="text-align:right" colspan="2"><?=number_format($row->costo,2,'.',',');?></td>
				</tr>
	<?
				$i++;
			endforeach;
