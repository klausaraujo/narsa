	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        <style>
			...
			*{ font-size: 13px; }
			...
			#main2{ position:fixed;top:20.9cm; }
        ...
        <main style="overflow-y:hidden">
			<table cellspacing="0" cellpadding="1" align="center" class="acciones">
				...
				<tr>
					...
					<td><?=sprintf("%'05s",$movimiento->idtransaccion)?></td><td colspan="2"><?=number_format(floatval(abs($movimiento->monto_factor_final + $movimiento->interes_pagado)),2,'.',',')?></td>
				</tr>
			</table>
		</main>
		<main id="main2">
