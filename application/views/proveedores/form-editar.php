								...
								<div class="col-sm-12 my-1">
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-4">
											<div class="row">
												<input type="text" class="form-control nombres mayusc" name="nombres" id="nombres" placeholder="Raz&oacute;n Social"
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-4">
											<div class="row">
												<input type="text" class="form-control zona mayusc" name="zona" id="zona" placeholder="Zona" value="<?=$proveedor->zona;?>" required="" />
											</div>
										</div>
									</div>
									<div class="row mt-3">
