				...
				<div class="container-fluid">
					...
					<?php 
						...
						elseif($this->uri->segment(1) === 'proveedores' && substr($this->uri->segment(2),0,strlen('reporte')) === 'reporte'
								&& $this->uri->segment(2) !== 'reporte8') $this->load->view('proveedores/reportes');
						elseif($this->uri->segment(1) === 'proveedores' && $this->uri->segment(2) === 'reporte8') $this->load->view('proveedores/complementario');
						...
						elseif($this->uri->segment(1) === 'ventas' && $this->uri->segment(2) === 'reporteventas') $this->load->view('ventas/reportes');
